...
SDK_RELEASE_VERSION="37.0.0" SDK_MIRROR_TAG="mirror-20260919" SDK_ARCHIVE="android-sdk-aarch64-linux-musl-20260919.tar.xz" SDK_URL="https://github.com/DesktopECHO/android-studio-aarch64-install/releases/download/${SDK_MIRROR_TAG}/${SDK_ARCHIVE}" SDK_SHA256="1d9c475b70f66ec21dc225b25388214aaa41521000ee35a3fe89d8bb7ed467a6"
NDK_VERSION="r30-beta3" NDK_DISPLAY_VERSION="r30" NDK_RELEASE_TAG="r30" NDK_MIRROR_TAG="mirror-20260919" NDK_BUILD_NUMBER="30.0.16138531" NDK_ARCHIVE="android-ndk-${NDK_VERSION}-aarch64-linux-musl-20260919.tar.xz" NDK_URL="https://github.com/DesktopECHO/android-studio-aarch64-install/releases/download/${NDK_MIRROR_TAG}/${NDK_ARCHIVE}" NDK_SHA256="8ef94e4e5aa9193f47eb90e7870ca3c4f6ab2239de166fb236fd19952374f991"
